    ...
    public static class FirewallTableDefinitions
    {
        public static readonly TableDefinition WixFirewallException = new TableDefinition(
            ...
            new[]
            {
                ...
                new ColumnDefinition("Attributes", ColumnType.Number, 4, primaryKey: false, nullable: true, ColumnCategory.Unknown, description: "Vital=1, EdgeTraversal=2"),
                ...
                new ColumnDefinition("Service", ColumnType.String, 256, primaryKey: false, nullable: true, ColumnCategory.Formatted, description: "Windows Service short name (optional)."),
                new ColumnDefinition("InterfaceTypes", ColumnType.String, 0, primaryKey: false, nullable: true, ColumnCategory.Unknown, description: "Optional comma separated list of interface types enforced by this firewall rule (combination of Wireless,Lan,RemoteAccess or All). Null is equivalent to All."),
            },
